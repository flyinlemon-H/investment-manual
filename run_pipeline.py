...
DEFAULT_MANUAL_FILENAME = "投资作战手册_V12.3-C.1.html"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--open-manual", action="store_true", help="Open dist/投资作战手册_V12.3-C.1.html after validation and copy succeed.")
    return parser
