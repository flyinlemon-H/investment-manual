(function(root,factory){
  ...
  return {STATUS,process,renderResult,buildStockIndex,eligibleEntries,buildCandidate,commit,createCommitController};
});
...
(function(root){
  ...
  async function confirmBatch(){
    ...
    const result=await commitController.run(currentPreview,state,{
      ...
      saveCandidate:(candidate,options)=>saveState(candidate,options),
