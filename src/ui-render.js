...
function currentActionPanel(stock){
  ...
  const risk=(tech&&tech.riskFlags&&tech.riskFlags.length?tech.riskFlags:[]).concat((d.warnings||[]).slice(0,2),ex.executionWarnings||[]).slice(0,4);
