...
function renderStockDetail(){
  ...
  document.getElementById('main').innerHTML=`<div data-v13-detail-anchor="overview">${detailHeroPanel(s,mv,actual,deviation)}</div>${v13ReviewReturnBanner(s)}${stockWorkspaceAccordion(s)}${detailAdvancedToolsArchivePanel(s)}`;
